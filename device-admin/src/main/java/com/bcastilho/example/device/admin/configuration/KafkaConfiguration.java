...
import com.bcastilho.example.device.admin.domain.DeviceSerializer;
...
public class KafkaConfiguration {
    ...
    @Value("${application.topics.device.topic-name}") // This is the topic name for the Kafka producer
    ...
    public KafkaStreamsConfiguration kafkaStreamsConfig() {
        ...
        props.put(StreamsConfig.DEFAULT_VALUE_SERDE_CLASS_CONFIG, DeviceSerdes.class.getName());
    ...
    @Bean
    public StoreBuilder<KeyValueStore<String, Device>> storeBuilder() {
    ...
    public SslEngineFactory sslEngineFactory() {
        return new DefaultSslEngineFactory() {
            ...
            public SSLEngine createClientSslEngine(String peerHost, int peerPort, String endpointIdentification) {
                return super.createClientSslEngine("localhost", peerPort, endpointIdentification);
            }
        };
    }
